"""Mapping tests: DeviceRecord -> Nautobot payload dict."""
...
from nautobot_consumer.mapper import MappingError, map_device_record
...
def test_minimal_record_maps_to_identity_and_last_seen(
    ...
    assert cf["rastreo_confidence"] == "0.20"
...
def test_full_record_maps_platform_and_role_as_names(
...
def test_platform_name_stripped_of_whitespace(
    minimal_record_payload: dict[str, Any],
) -> None:
