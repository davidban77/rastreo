...
class Config:
    ...
    infrahub_token: str
    infrahub_branch: str
    infrahub_auto_merge: bool
    infrahub_timeout_seconds: int
    log_level: str
    dry_run: bool
    ...
    def from_env(cls, *, load_dotenv_file: bool = True) -> Config:
        ...
        required = ("KAFKA_BROKERS", "INFRAHUB_URL", "INFRAHUB_TOKEN")
        ...
        return cls(
            ...
            kafka_group_id=os.environ.get("KAFKA_GROUP_ID", "rastreo-infrahub-consumer"),
            kafka_auto_offset_reset=offset_reset,
            poll_timeout_ms=_int("POLL_TIMEOUT_MS", "1000"),
            infrahub_url=os.environ["INFRAHUB_URL"].strip().rstrip("/"),
            infrahub_token=os.environ["INFRAHUB_TOKEN"].strip(),
            infrahub_branch=os.environ.get("INFRAHUB_BRANCH", "rastreo-updates").strip(),
            infrahub_auto_merge=_bool("INFRAHUB_AUTO_MERGE", "false"),
            infrahub_timeout_seconds=_int("INFRAHUB_TIMEOUT_SECONDS", "30"),
            log_level=log_level,
