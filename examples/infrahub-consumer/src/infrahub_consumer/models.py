...
`schemas/device-record-v1.json`. This module models only the fields the Infrahub
...
class DeviceRecord(BaseModel):
    """The subset of `DeviceRecord` the Infrahub reconciler reads.
    ...
    raw list into the `signals` JSON attribute verbatim; nothing here needs to
    interpret the tag.
    """
