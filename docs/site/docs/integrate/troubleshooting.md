...
```bash
# from the host:
rastreo discover --sink kafka --brokers localhost:9092 --topic rastreo.discovery.records.v1 ...

# from a container on rastreo-net:
rastreo discover --sink kafka --brokers kafka:29092 --topic rastreo.discovery.records.v1 ...
```
