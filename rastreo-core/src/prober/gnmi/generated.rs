pub mod gnmi {
    ...
    pub struct Subscription {
        ...
        ///    not.
        /// 1. A heartbeat_interval MAY be specified to modify the behavior of
...
pub mod gnmi_ext {
    ...
    pub struct Extension {
        #[prost(oneof = "extension::Ext", tags = "1, 2, 3, 4, 5, 6")]
    ...
    pub mod extension {
        ...
        pub enum Ext {
            ...
            #[prost(message, tag = "6")]
            ConfigSubscription(super::ConfigSubscription),
        }
    }
    ...
    pub struct Commit {
        ...
        #[prost(string, tag = "1")]
        pub id: ::prost::alloc::string::String,
        #[prost(oneof = "commit::Action", tags = "2, 3, 4, 5")]
        pub action: ::core::option::Option<commit::Action>,
    }
    ...
    pub mod commit {
        ...
        pub enum Action {
            ...
            #[prost(message, tag = "5")]
            SetRollbackDuration(super::CommitSetRollbackDuration),
        }
    }
    ...
    pub struct CommitRequest {
        ...
        #[prost(message, optional, tag = "1")]
        pub rollback_duration: ::core::option::Option<::prost_types::Duration>,
    }
    ...
    #[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct CommitSetRollbackDuration {
        /// Maximum duration to wait for a confirmaton before reverting the commit.
        #[prost(message, optional, tag = "1")]
        pub rollback_duration: ::core::option::Option<::prost_types::Duration>,
    }
    ...
    pub struct ConfigSubscription {
        #[prost(oneof = "config_subscription::Action", tags = "1, 2")]
        pub action: ::core::option::Option<config_subscription::Action>,
    }
    /// Nested message and enum types in `ConfigSubscription`.
    pub mod config_subscription {
        #[derive(Clone, PartialEq, Eq, Hash, ::prost::Oneof)]
        pub enum Action {
            /// ConfigSubscriptionStart is sent by the client in the SubscribeRequest
            #[prost(message, tag = "1")]
            Start(super::ConfigSubscriptionStart),
            /// ConfigSubscriptionSyncDone is sent by the server in the SubscribeResponse
            #[prost(message, tag = "2")]
            SyncDone(super::ConfigSubscriptionSyncDone),
        }
    }
